...
def train(rank, cfg, a):
    ...
    # Model DDP
    generator = asmr_res(cfg.embed, cfg.hifigan).to(device)
    ...
    for epoch in range(max(0, last_epoch), cfg.train["n_epoch"]):
        ...
        for i, batch in enumerate(train_loader):
            ...
            loss_mel = F.l1_loss(y_mel, y_g_hat_mel) * 50 # Default to 45
...
def main():
    ...
    parser.add_argument('--experiment_name', default='asr_residual')
    a = parser.parse_args()
